...
-- ⚙️ CONFIG
local teleportDelay = 7
local teleportPoints = {
    Vector3.new(-464, 16, 27),
    Vector3.new(-673, 232, 432),
    Vector3.new(-520, 304, 551),
    Vector3.new(-625, 385, 684),
    Vector3.new(-627, 368, 889),
    Vector3.new(-17, 296, 920),
    Vector3.new(469, 359, 906),
    Vector3.new(420, 392, 676),
    Vector3.new(458, 328, -81),
    Vector3.new(635, 332, -89),
    Vector3.new(682, 208, -591),
    Vector3.new(281, 176, -405),
    Vector3.new(306, 199, -191),
    Vector3.new(60, 216, -137),
    Vector3.new(-14, 216, -241),
    Vector3.new(32, 172, -610),
    Vector3.new(-230, 172, -659),
    Vector3.new(-114, 336, -785),
    Vector3.new(157, 340, -773),
    Vector3.new(303, 375, -788),
    Vector3.new(631, 578, -1212),
    Vector3.new(381, 654, -1276),
    Vector3.new(365, 691, -1387),
    Vector3.new(288, 752, -1284),
    Vector3.new(289, 742, -1425),
    Vector3.new(199, 820, -1789),
    Vector3.new(-35, 900, -1863),
    Vector3.new(-107, 936, -2318),
    Vector3.new(-1249, 1000, -2476),
    Vector3.new(-1646, 1048, -2476),
    Vector3.new(-1864, 1128, -2387),
    Vector3.new(-2015, 1196, -1921)
}
