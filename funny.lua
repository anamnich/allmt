...
-- ⚙️ CONFIG
local teleportDelay = 13
local teleportPoints = {
    Vector3.new(843, 365, -811),
    Vector3.new(841, 439, -313),
    Vector3.new(635, 493, 88),
    Vector3.new(212, 552, 511),
    Vector3.new(-295, 604, 497),
    Vector3.new(-349, 688, 778),
    Vector3.new(-547, 795, 1218),
    Vector3.new(-578, 939, 1738)
}
