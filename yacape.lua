...
local teleportPoints = {
    Vector3.new(-751, 324, 757),
    Vector3.new(-315, 368, 609),
    Vector3.new(-211, 500, 398),
    Vector3.new(248, 500, 394),
    Vector3.new(386, 524, 338),
    Vector3.new(64, 365, 100),
    Vector3.new(16, 340, -309),
    Vector3.new(-892, 732, -627),
    Vector3.new(-968, 743, -600)
}
